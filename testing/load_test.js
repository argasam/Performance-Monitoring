...
export const options = {
    ...
    // vus: 50,
    stages: [
        { target: 10, duration: '30s' }, // Below Normal Load
        { target: 10, duration: '2m' }, // continue
        { target: 25, duration: '30s' }, // normal load
        { target: 25, duration: '2m' }, // continue
        { target: 50, duration: '30s' }, // breaking point
        { target: 50, duration: '2m' }, // continue
        { target: 100, duration: '30s' }, // beyond breaking
