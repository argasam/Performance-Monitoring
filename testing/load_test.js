...
export const options = {
    ...
    // vus: 50,
    stages: [
        { target: 100, duration: '30s' }, // Below Normal Load
        { target: 100, duration: '2m' }, // continue
        { target: 200, duration: '30s' }, // normal load
        { target: 200, duration: '2m' }, // continue
        { target: 300, duration: '30s' }, // breaking point
        { target: 300, duration: '2m' }, // continue
        { target: 400, duration: '30s' }, // beyond breaking
        { target: 400, duration: '2m' }, // continue
        { target: 0, duration: '3m' }, // Scale down. recovery
    ],
};
