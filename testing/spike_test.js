...
export const options = {
    ...
    vus: 50,
    stages: [
        { target: 50, duration: '10s' }, // Below Normal Load
        { target: 50, duration: '1m' }, // continue
        { target: 100, duration: '10s' }, // normal load
        { target: 100, duration: '3m' }, // continue
        { target: 50, duration: '10s' }, // breaking point
        { target: 50, duration: '3m' }, // continue
        { target: 0, duration: '10s' }, // Scale down. recovery
    ],
};
