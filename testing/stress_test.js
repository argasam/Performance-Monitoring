...
export const options = {
    ...
    stages: [
        ...
        { target: 30, duration: '30s' }, // normal load
        { target: 30, duration: '2m' }, // continue
        { target: 40, duration: '30s' }, // breaking point
        { target: 40, duration: '2m' }, // continue
        { target: 50, duration: '30s' }, // beyond breaking
